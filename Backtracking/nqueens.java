...
class Main{
    public LinkedList<List<String>> solveNQueens(int n) {
    ...
    public static void f(int col,char[][] board,LinkedList<List<String>> ans,int row[],int ld[],int rd[] ){
        if(col==board.length){
    ...
    static LinkedList<String> construct(char[][] board) {
